    ...
    <form action="{{ route('coverages.store') }}" method="POST" class="p-6">
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="area_name" id="area_name" value="{{ old('area_name') }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors @error('area_name') border-red-500 @enderror" placeholder="Contoh: Perumahan Indah Jaya">
                @error('area_name')
